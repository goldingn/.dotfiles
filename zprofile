...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/Users/nick/anaconda2/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/Users/nick/anaconda2/etc/profile.d/conda.sh" ]; then
        . "/Users/nick/anaconda2/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/Users/nick/anaconda2/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda init <<<
